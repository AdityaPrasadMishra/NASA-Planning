...
double decrease_rem_time_today_action_completing_activity(double rem_time_today ) {
	 return round_k_digits(rem_time_today-(1.00000),4.000000); 
}
...
double assign_rem_time_today_action_starting_day_for_crewmember() {
	 return round_k_digits(3.00000,4.000000); 
}
